...
var KTAppInbox = function() {
            ...
            templates: {
                dropdownItem: function(tagData) {
                    try {
                        ...
                        html += '           <a href="javascript:void(0);" class="text-dark-75 text-hover-primary font-weight-bold">'+ (tagData.value ? tagData.value : '') + '</a>';
    ...
    return {
        ...
        init: function() {
            ...
            _editEl = KTUtil.getById('note-edit');
        ...
        initReply: function() {
            //_initEditor(_editEl, 'note-edit_editor');
